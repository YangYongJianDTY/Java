...
public class T06 {
	...
	public static void main(String args[]) {
		...
		position = path.indexOf("\\A.java");	//获取path中最后出现目录分隔符号的位置
		System.out.println("c:\\java\\jsp\\A.java中最后出现\\的位置:" +position); 
		String path2 = path.split("\\\\A")[0];	//获取 “A.java”文件的路径。
		System.out.println(path2);	//输出：A.java文件的路径为：”c:\java\jsp” 
